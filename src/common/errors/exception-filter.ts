...
export default class ExceptionFilter implements ExceptionFilterInterface {
  ...
  private handleHttpError(error: HttpError, _req: Request, res: Response, _next: NextFunction) {
    ...
    res
      ...
      .json(createErrorObject(ErrorService.CommonError, error.message));
  }
  ...
  private handleOtherError(error: Error, _req: Request, res: Response, _next: NextFunction): void {
    ...
    res
      ...
      .json(createErrorObject(ErrorService.ServiceError, error.message));
  }
  ...
  private handleValidationError(error: ValidationError, _req: Request, res: Response, _next: NextFunction) {
    ...
    res
      ...
      .json(createErrorObject(ErrorService.ValidationError, error.message, error.details));
  }
